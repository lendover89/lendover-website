  ...
  function startGeo3D() {
      ...
      function tama1PlanningCategory(feature) {
        ...
        const text = normalizedCategoryKey([
          ...
          props.stage, props.STAGE, props.MIRKAM, props.SVIVA
        ].filter(Boolean).join(' '));
        if (!text) return '';
        if (text.includes('דלק')) return 'תשתיות / דלק';
        if (text.includes('חופ') || text.includes('300 מטר')) return 'חוף';
        if (text.includes('הצפה') || text.includes('פשט')) return 'הצפות';
        if (text.includes('זיהום') || text.includes('הידרולוג') || text.includes('תהום') || text.includes('מים')) return 'מים / הידרולוגיה';
        if (text.includes('יער') || text.includes('שמורה') || text.includes('גן לאומי') || text.includes('מוגנ') || text.includes('שמור')) return 'טבע / שימור';
        return '';
      }
        ...
        map.addLayer({
         ...
         paint: {
           ...
           'fill-opacity': [
             ...
             11,
             ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.012,
                ['==', ['get', 'planning_category_key'], 'חוף'], 0.012,
                ['==', ['get', 'planning_category_key'], 'תשתיות / דלק'], 0.012,
                ['==', ['get', 'planning_category_key'], 'הצפות'], 0.045,
                ['==', ['get', 'planning_category_key'], 'מים / הידרולוגיה'], 0.055,
                0.03
             ],
             16,
             ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.028,
                ['==', ['get', 'planning_category_key'], 'חוף'], 0.026,
                ['==', ['get', 'planning_category_key'], 'תשתיות / דלק'], 0.024,
                ['==', ['get', 'planning_category_key'], 'הצפות'], 0.09,
                ['==', ['get', 'planning_category_key'], 'מים / הידרולוגיה'], 0.11,
                0.065
             ]
           ]
         }
        ...
        map.addLayer({
          ...
          paint: {
            ...
            'line-width': [
             ...
             11,
             ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.45,
               ['match', ['get', 'planning_category_key'], ['חוף', 'תשתיות / דלק'], true, false], 1.4,
               0.8
             ],
             16,
             ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 1,
               ['match', ['get', 'planning_category_key'], ['חוף', 'תשתיות / דלק'], true, false], 3.2,
               2
             ]
           ],
            'line-opacity': [
              'case',
              ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.28,
              ['==', ['get', 'planning_category_key'], 'חוף'], 0.82,
              ['==', ['get', 'planning_category_key'], 'תשתיות / דלק'], 0.9,
              0.72
            ]
          }
        });
