        ...
        map.addLayer({
          ...
          paint: {
            ...
            'fill-opacity': [
              ...
              11,
              ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.035,
                ['==', ['get', 'planning_category_key'], 'הצפות'], 0.09,
                ['==', ['get', 'planning_category_key'], 'מים / הידרולוגיה'], 0.1,
                0.08
              ],
              16,
              ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.08,
                ['==', ['get', 'planning_category_key'], 'הצפות'], 0.18,
                ['==', ['get', 'planning_category_key'], 'מים / הידרולוגיה'], 0.2,
                0.14
              ]
            ]
          }
        ...
        map.addLayer({
          ...
          paint: {
            ...
            'line-width': [
              ...
              11,
              ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.35,
                ['match', ['get', 'planning_category_key'], ['חוף', 'תשתיות / דלק'], true, false], 1.4,
                0.8
              ],
              16,
              ['case',
                ['==', ['get', 'planning_category_key'], 'טבע / שימור'], 0.8,
