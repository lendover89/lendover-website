(function () {
  ...
  function startGeo3D() {
      ...
      const DETAILED_PLANNING_FIXED_COLORS = {
        ...
        'רגישות הידרולוגית · בינונית': '#0ea5e9',
        'רגישות הידרולוגית · נמוכה': '#7dd3fc',
        'רגישות הידרולוגית': '#38bdf8',
        'פשט הצפה': '#00a7ff',
        'שטח הצפה': '#67e8f9',
        'יער טבעי': '#00856f',
        'יער פארק': '#a3e635',
        ...
        map.addLayer({
         ...
         paint: {
           ...
           'fill-opacity': [
             ...
             11,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 0.035,
             ...
             16,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 0.07,
        ...
        map.addLayer({
          ...
          paint: {
            ...
            'line-width': [
              ...
              11,
              ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 1.6,
                ['match', ['get', 'planning_category_key'], ['קו סביבה חופית 300 מ׳', 'רצועת דלק'], true, false], 2.5,
                2.1
              ],
              16,
              ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 3,
            ...
            'line-opacity': [
              'case',
              ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 0.42,
              0.55
            ]
          }
        });
        ...
        map.addLayer({
          ...
          paint: {
            ...
            'line-width': [
             ...
             11,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 0.95,
               ['match', ['get', 'planning_category_key'], ['קו סביבה חופית 300 מ׳', 'רצועת דלק'], true, false], 1.8,
               1.25
             ],
             16,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 1.7,
            ...
            'line-opacity': [
              'case',
              ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 0.72,
