  ...
  function startGeo3D() {
      ...
      function table5RightsRowHtml(row) {
        ...
        const rows = [
          ...
          ['סה"כ שטחי בנייה', row.floor_area_total_m2 ? formatRightsNumber(row.floor_area_total_m2, 2) + ' מ"ר' : ''],
          ['עיקרי', row.floor_area_main_m2 ? formatRightsNumber(row.floor_area_main_m2, 2) + ' מ"ר' : ''],
          ['שירות', row.floor_area_service_m2 ? formatRightsNumber(row.floor_area_service_m2, 2) + ' מ"ר' : ''],
          ...
          ['קומות', row.floors ? formatRightsNumber(row.floors, 0) : ''],
