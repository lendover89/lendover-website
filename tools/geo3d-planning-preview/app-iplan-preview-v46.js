(function () {
  ...
  function startGeo3D() {
      ...
      const DETAILED_PLANNING_FIXED_COLORS = {
        ...
        'מוגנים': '#84cc16',
        'מים': '#0ea5e9',
        'מים / הידרולוגיה': '#2563eb',
        'הצפות': '#06b6d4',
        'טבע / שימור': '#16a34a',
        'חוף': '#f59e0b',
        'תשתיות / דלק': '#e11d48',
        'זיהום מי תהום': '#ef4444',
        'רגישות הידרולוגית · גבוהה מאוד': '#1d4ed8',
        'רגישות הידרולוגית · גבוהה': '#2563eb',
        'רגישות הידרולוגית · בינונית': '#38bdf8',
        'רגישות הידרולוגית · נמוכה': '#93c5fd',
        'רגישות הידרולוגית': '#60a5fa',
        'פשט הצפה': '#0891b2',
        'שטח הצפה': '#22d3ee',
        'יער טבעי': '#15803d',
        'יער פארק': '#65a30d',
        ...
        'שמורת טבע': '#16a34a',
        'גן לאומי': '#a3e635',
        'קו סביבה חופית 300 מ׳': '#f59e0b',
        'רצועת דלק': '#e11d48',
        'דרכים': '#f59e0b',
        'מסילות רכבת': '#ef4444',
        'רצועות דרך': '#eab308',
        'דרך מהירה קיימת': '#ef4444',
        'דרך מהירה מוצעת': '#fb7185',
        'דרך ראשית קיימת': '#f97316',
        'דרך ראשית מוצעת': '#facc15',
        'דרך אזורית קיימת': '#22c55e',
        'דרך אזורית מוצעת': '#84cc16',
        'תכנית דרך מאושרת': '#7c3aed',
        'תכנית דרך מוצעת': '#38bdf8',
        'מפגש דרך-מסילה': '#d946ef',
        'מנהרה / מעבר תחתי': '#0f172a',
        'דרך לביטול': '#64748b',
        'מסילת רכבת מאושרת': '#6d28d9',
        'מסילת רכבת עם הוראות מעבר': '#2563eb',
        'תחנות רכבת': '#ffffff',
        'מרכז תחבורה': '#14b8a6',
        'מסופי גבול': '#ec4899',
        ...
        'מרחב ליבה': '#7c3aed',
        'טבעת ראשונה': '#22c55e',
        'תחום חיפוש למעבר ציבורי': '#f59e0b',
        'גבול תמ״א 70': '#f8fafc'
      };
        ...
        map.addLayer({
         ...
         paint: {
           ...
           'fill-opacity': [
             ...
             11,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי', 'קו סביבה חופית 300 מ׳', 'רצועת דלק'], true, false], 0.012,
                ['match', ['get', 'planning_category_key'], ['פשט הצפה', 'שטח הצפה'], true, false], 0.045,
                ['match', ['get', 'planning_category_key'], ['זיהום מי תהום', 'רגישות הידרולוגית · גבוהה מאוד', 'רגישות הידרולוגית · גבוהה'], true, false], 0.055,
                ['match', ['get', 'planning_category_key'], ['רגישות הידרולוגית · בינונית', 'רגישות הידרולוגית · נמוכה', 'רגישות הידרולוגית'], true, false], 0.035,
                0.03
             ],
             16,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי', 'קו סביבה חופית 300 מ׳', 'רצועת דלק'], true, false], 0.028,
                ['match', ['get', 'planning_category_key'], ['פשט הצפה', 'שטח הצפה'], true, false], 0.09,
                ['match', ['get', 'planning_category_key'], ['זיהום מי תהום', 'רגישות הידרולוגית · גבוהה מאוד', 'רגישות הידרולוגית · גבוהה'], true, false], 0.11,
                ['match', ['get', 'planning_category_key'], ['רגישות הידרולוגית · בינונית', 'רגישות הידרולוגית · נמוכה', 'רגישות הידרולוגית'], true, false], 0.075,
                0.065
             ]
           ]
         }
        ...
        map.addLayer({
          ...
          paint: {
            ...
            'line-width': [
             ...
             11,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 0.45,
               ['match', ['get', 'planning_category_key'], ['קו סביבה חופית 300 מ׳', 'רצועת דלק'], true, false], 1.4,
               0.8
             ],
             16,
             ['case',
                ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 1,
               ['match', ['get', 'planning_category_key'], ['קו סביבה חופית 300 מ׳', 'רצועת דלק'], true, false], 3.2,
               2
             ]
           ],
            'line-opacity': [
              'case',
              ['match', ['get', 'planning_category_key'], ['יער טבעי', 'יער פארק', 'יער נטע אדם', 'יער', 'שמורת טבע', 'גן לאומי'], true, false], 0.32,
              ['==', ['get', 'planning_category_key'], 'קו סביבה חופית 300 מ׳'], 0.82,
