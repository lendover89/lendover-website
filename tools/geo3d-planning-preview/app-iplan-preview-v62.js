  ...
  function startGeo3D() {
      ...
      const PLANNING_CONFIG = {
        ...
        urbanRenewal: {
          ...
          geojsonUrl: 'urban-renewal-planning.geojson?v=20260617a',
          minZoom: 8
        }
      };
      ...
      const DETAILED_PLANNING_FIXED_COLORS = {
        ...
        'גבול תמ״א 70': '#f8fafc',
        'טרם הוכרז': '#94a3b8',
        'תכנון סטטוטורי': '#f59e0b',
        'מאושרת לפני מימוש': '#38bdf8',
        'מאושרת במימוש': '#22c55e',
        'מאושרת אחרי רישוי': '#16a34a',
        'בתהליך': '#f97316',
        'בטרום תכנון': '#a78bfa',
        'מאושרת': '#22c55e',
        'נדחתה/בוטלה': '#ef4444',
      ...
      function planningDetailedCategoryLabel(feature, key) {
        ...
        if (key === 'urbanRenewal') {
          return props.status_label || props.statushars || props.statustich || 'ללא סטטוס';
        }
