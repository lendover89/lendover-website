(function () {
  ...
  function startGeo3D() {
      ...
      const DETAILED_PLANNING_FIXED_COLORS = {
        ...
        'מסילות רכבת': '#ef4444',
        'רצועות דרך': '#eab308',
        'דרך מהירה קיימת': '#f97316',
        'דרך מהירה מוצעת': '#fb923c',
        'דרך ראשית קיימת': '#f59e0b',
        'דרך ראשית מוצעת': '#facc15',
        'דרך אזורית קיימת': '#84cc16',
        'דרך אזורית מוצעת': '#bef264',
        'תכנית דרך מאושרת': '#64748b',
        'תכנית דרך מוצעת': '#38bdf8',
        'מפגש דרך-מסילה': '#a855f7',
        'מנהרה / מעבר תחתי': '#0f172a',
        'דרך לביטול': '#ef4444',
        'מסילת רכבת מאושרת': '#06b6d4',
        'מסילת רכבת עם הוראות מעבר': '#0891b2',
      ...
      function transportText(feature) {
        ...
        return normalizedCategoryKey([
          ...
          props.Tochnit__1, props.Related, props.Status, props.STATUS
        ].filter(Boolean).join(' '));
      }
