(function () {
  ...
  function startGeo3D() {
      ...
      function parcelInfoHtml(props, groundwaterState) {
        ...
        return '<div class="planning-panel__context">חלקה נבחרת</div>' +
      ...
      function identifyParcelAt(e) {
        ...
        setPlanningPanelHtml(parcelInfoHtml(props, selectedParcel.groundwater));
      ...
      function refreshSelectedParcelPanel() {
        ...
        setPlanningPanelVisibility(true);
        setPlanningPanelHtml(parcelInfoHtml(selectedParcel.props, selectedParcel.groundwater));
      }
    ...
    postGeo3DUsage('reset_view');
      ...
      map.on('click', async (e) => {
        ...
        if (await identifyPlanningAt(e)) {
          clearParcelSelection({ clearPanel: false });
          return;
        }
