  ...
  function startGeo3D() {
      ...
      const PLANNING_CONFIG = {
        ...
        notice77: {
          ...
          urls: [
            IPLAN_API + '/Xplan_77_78/MapServer/1/query',
            IPLAN_API + '/Xplan_77_78/MapServer/2/query',
            IPLAN_API + '/Xplan_77_78/MapServer/3/query',
      ...
      function planningFeatureLabel(feature) {
        ...
        if (key === 'notice77') return props.PL_NAME || props.pl_name || props.PLAN_NAME || genericName || 'תכנית 77/78';
      ...
      planningLayerButtons.forEach((button) => {
        button.addEventListener('click', () => {
          ...
          if (planningLayerEnabled[key] && ['notice77', 'tama1', 'transport', 'tama70'].includes(key)) {
            zoomToPracticalMinimum(button.textContent || 'שכבה תכנונית', PRACTICAL_LAYER_ZOOM.planningDetailed);
          }
          updatePlanningLayerButtonStates();
